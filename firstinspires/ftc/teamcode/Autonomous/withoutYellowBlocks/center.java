package org.firstinspires.ftc.teamcode.Autonomous.withoutYellowBlocks;
...
@Autonomous(name="CenterStart",group="NoYelloBlocks")
public class center extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        //TODO ACN YOU PLEAES NO USE NEGATIVE POWER
            ...
            driveStraight(0.3,0,-0.40);
            sleep(300); //armcontrol
            driveStraight(0.1,0,0.2);
            driveSeide(0.3,0,1.5);
    }
    ...
    public void driveStraight(double power, int angle, double meter) {
        ...
        loop = true;
        telemetry.addData("Meter Taget", meter);
        telemetry.update();
    }
    ...
    public double AverageDist() {
        double dist =((((double) (
                (frontLeft.getCurrentPosition() - M2C) -
                        (backRight.getCurrentPosition() - M3C)
        )) / 2) / 7002);
        //4453
...
//        telemetry.addData("right", backRight.getCurrentPosition());
    ...
    public double AverageDistSide() {
        double dist = ((((double)
                (-(backLeft.getCurrentPosition() - M4C)
                ))) / 9802) * -1;
